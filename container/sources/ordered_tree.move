...
module container::ordered_tree {
    ...
    public fun destroy_empty<V>(tree: BinarySearchTree<V>) {
        let BinarySearchTree { entries, root: _, tree_type: _, min_index: _, max_index: _ } = tree;
    ...
    // returns
    // - the parent tree.
    fun rb_update_insert<V>(tree: &mut BinarySearchTree<V>, index: u64, is_right: bool): u64 {
