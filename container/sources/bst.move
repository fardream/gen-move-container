...
module container::vanilla_binary_search_tree {
    ...
    #[test_only]
    fun new_entry_for_test<V>(key: u128, value: V, parent: u64, left_child: u64, right_child: u64): Entry<V> {
        Entry {
            key,
            value,
            parent,
    ...
    public fun find<V>(tree: &BinarySearchTree<V>, key: u128): u64 {
    ...
    public fun borrow_at_index<V>(tree: &BinarySearchTree<V>, index: u64): (u128, &V) {
    ...
    public fun borrow_at_index_mut<V>(tree: &mut BinarySearchTree<V>, index: u64): (u128, &mut V) {
    ...
    public fun remove<V>(tree: &mut BinarySearchTree<V>, index: u64): (u128, V) {
        ...
        ////////// now clear up.
        let Entry { key,  value, parent: _, left_child: _, right_child: _ } = vector::pop_back(&mut tree.entries);
