...
module container::avl {
    ...
    public fun find<V>(tree: &AvlTree<V>, key: u256): u64 {
    ...
    public fun borrow_at_index<V>(tree: &AvlTree<V>, index: u64): (u256, &V) {
    ...
    public fun borrow_at_index_mut<V>(tree: &mut AvlTree<V>, index: u64): (u256, &mut V) {
    ...
    public fun insert<V>(tree: &mut AvlTree<V>, key: u256, value: V) {
    ...
    public fun remove<V>(tree: &mut AvlTree<V>, index: u64): (u256, V) {
    ...
    fun test_avl() {
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(5, 5, NULL_INDEX, 2, 0, AVL_ZERO),
            new_entry_for_test<u256>(4, 4, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(5, 5, NULL_INDEX, 4, 0, AVL_LEFT_HIGH),
            new_entry_for_test<u256>(4, 4, 4, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(1, 1, 4, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(3, 3, 1, 3, 2, AVL_ZERO),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO), // 0
            new_entry_for_test<u256>(5, 5, 4, 2, 0, AVL_ZERO), // 1
            new_entry_for_test<u256>(4, 4, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO), // 2
            new_entry_for_test<u256>(1, 1, 4, NULL_INDEX, 5, AVL_RIGHT_HIGH), // 3
            new_entry_for_test<u256>(3, 3, NULL_INDEX, 3, 1, AVL_ZERO), // 4
            new_entry_for_test<u256>(2, 2, 3, NULL_INDEX, NULL_INDEX, AVL_ZERO), // 5
        ];
    ...
    fun test_avl_reverse() {
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(7, 7, NULL_INDEX, 0, 2, AVL_ZERO),
            new_entry_for_test<u256>(8, 8, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(7, 7, NULL_INDEX, 0, 4, AVL_RIGHT_HIGH),
            new_entry_for_test<u256>(8, 8, 4, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(11, 11, 4, NULL_INDEX, NULL_INDEX, AVL_ZERO),
            new_entry_for_test<u256>(9, 9, 1, 2, 3, AVL_ZERO),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO), // 0
            new_entry_for_test<u256>(7, 7, 4, 0, 2, AVL_ZERO), // 1
            new_entry_for_test<u256>(8, 8, 1, NULL_INDEX, NULL_INDEX, AVL_ZERO), // 2
            new_entry_for_test<u256>(11, 11, 4, 5, NULL_INDEX, AVL_LEFT_HIGH), // 3
            new_entry_for_test<u256>(9, 9, NULL_INDEX, 1, 3, AVL_ZERO), // 4
            new_entry_for_test<u256>(10, 10, 3, NULL_INDEX, NULL_INDEX, AVL_ZERO), // 5
        ];
