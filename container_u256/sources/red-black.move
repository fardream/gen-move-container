...
module container::red_black {
    ...
    #[test_only]
    fun new_entry_for_test<V>(key: u256, value: V, parent: u64, left_child: u64, right_child: u64, metadata: u8): Entry<V> {
        Entry {
            key,
            value,
            parent,
    ...
    public fun find<V>(tree: &RedBlackTree<V>, key: u256): u64 {
    ...
    public fun borrow_at_index<V>(tree: &RedBlackTree<V>, index: u64): (u256, &V) {
    ...
    public fun borrow_at_index_mut<V>(tree: &mut RedBlackTree<V>, index: u64): (u256, &mut V) {
    ...
    public fun insert<V>(tree: &mut RedBlackTree<V>, key: u256, value: V) {
    ...
    public fun remove<V>(tree: &mut RedBlackTree<V>, index: u64): (u256, V) {
    ...
    fun test_redblack() {
        ...
        insert(&mut tree, 5, 5);
        insert(&mut tree, 4, 4);
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_RED),
            new_entry_for_test<u256>(5, 5, NULL_INDEX, 2, 0, RB_BLACK),
            new_entry_for_test<u256>(4, 4, 1, NULL_INDEX, NULL_INDEX, RB_RED),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(5, 5, NULL_INDEX, 2, 0, RB_BLACK),
            new_entry_for_test<u256>(4, 4, 1, 3, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(1, 1, 2, NULL_INDEX, NULL_INDEX, RB_RED),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(5, 5, NULL_INDEX, 4, 0, RB_BLACK),
            new_entry_for_test<u256>(4, 4, 4, NULL_INDEX, NULL_INDEX, RB_RED),
            new_entry_for_test<u256>(1, 1, 4, NULL_INDEX, NULL_INDEX, RB_RED),
            new_entry_for_test<u256>(3, 3, 1, 3, 2, RB_BLACK),
        ];
        insert(&mut tree, 3, 3);
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(5, 5, NULL_INDEX, 4, 0, RB_BLACK),
            new_entry_for_test<u256>(4, 4, 4, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(1, 1, 4, NULL_INDEX, 5, RB_BLACK),
            new_entry_for_test<u256>(3, 3, 1, 3, 2, RB_RED),
            new_entry_for_test<u256>(2, 2, 3, NULL_INDEX, NULL_INDEX, RB_RED), // 5
        ];
    ...
    fun test_redblack_reverse() {
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_RED),
            new_entry_for_test<u256>(7, 7, NULL_INDEX, 0, 2, RB_BLACK),
            new_entry_for_test<u256>(8, 8, 1, NULL_INDEX, NULL_INDEX, RB_RED),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(7, 7, NULL_INDEX, 0, 2, RB_BLACK),
            new_entry_for_test<u256>(8, 8, 1, NULL_INDEX, 3, RB_BLACK),
            new_entry_for_test<u256>(11, 11, 2, NULL_INDEX, NULL_INDEX, RB_RED),
        ];
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(7, 7, NULL_INDEX, 0, 4, RB_BLACK),
            new_entry_for_test<u256>(8, 8, 4, NULL_INDEX, NULL_INDEX, RB_RED),
            new_entry_for_test<u256>(11, 11, 4, NULL_INDEX, NULL_INDEX, RB_RED),
            new_entry_for_test<u256>(9, 9, 1, 2, 3, RB_BLACK),
        ];
        insert(&mut tree, 9, 9);
        assert!(&tree.entries == &v, 4);
        ...
        let v = vector<Entry<u256>> [
            new_entry_for_test<u256>(6, 6, 1, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(7, 7, NULL_INDEX, 0, 4, RB_BLACK),
            new_entry_for_test<u256>(8, 8, 4, NULL_INDEX, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(11, 11, 4, 5, NULL_INDEX, RB_BLACK),
            new_entry_for_test<u256>(9, 9, 1, 2, 3, RB_RED),
            new_entry_for_test<u256>(10, 10, 3, NULL_INDEX, NULL_INDEX, RB_RED), // 5
        ];
